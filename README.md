...
- **Reset** restarts one player and removes that player's score.
- **Clear Game** archives the entire session, closes registration and player access, and removes it from the host Active Games list. Historical records remain in the database for reporting.
