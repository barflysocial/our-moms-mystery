...
- Corrected the registration and resume PIN fields in `public/app.js`.
- Replaced `pattern="\d{4}"` with the browser-safe `pattern="[0-9]{4}"`.
- Added a regression assertion covering both PIN inputs.
- Server-side four-digit PIN validation remains unchanged.
